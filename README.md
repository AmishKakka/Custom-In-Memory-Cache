...
### With WAL(Write Ahead Logging) using batched writes to file

```text
Memory Stats [Before testing...]:
Heap Alloc:      0.17 MB (Active data in RAM)
Total Alloc:     0.17 MB (Cumulative lifetime memory churn)
Sys (OS Memory): 7.77 MB (RAM reserved from the OS)
GC Cycles Run:   0 times (Garbage collector)
Running 5 workers x 6000 iterations (180,000 total cache operations)...

Memory Stats [Mid-operation memory check: ]:
Heap Alloc:      2.83 MB (Active data in RAM)
Total Alloc:     5.90 MB (Cumulative lifetime memory churn)
Sys (OS Memory): 13.35 MB (RAM reserved from the OS)
GC Cycles Run:   1 times (Garbage collector)

Memory Stats [Mid-operation memory check: ]:
Heap Alloc:      2.89 MB (Active data in RAM)
Total Alloc:     5.96 MB (Cumulative lifetime memory churn)
Sys (OS Memory): 13.35 MB (RAM reserved from the OS)
GC Cycles Run:   1 times (Garbage collector)
Worker 2 successfully processed 6000 iterations
Worker 5 successfully processed 6000 iterations
...
All concurrent operations completed cleanly in 1.591108459s!

Memory Stats [All operations completed...]:
Heap Alloc:      1.93 MB (Active data in RAM)
Total Alloc:     11.66 MB (Cumulative lifetime memory churn)
Sys (OS Memory): 13.52 MB (RAM reserved from the OS)
GC Cycles Run:   3 times (Garbage collector)
```

The significant change in time taken for the whole simulation is due to writing to a file (WAL) in batches of 256 mutations and making sure it is persisted to disk, but it does guarantee **durability**.
